...
const Tip = () => {
  ...
  const [nearestPoliceStation, setNearestPoliceStation] = useState("Rajouri Garden Station");
  ...
  return address == null ? (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-slate-100">
      ...
      {address ? (
        <p className="px-2 py-1 rounded-full bg-gray-200 hover:bg-gray-300 font-mono font-medium cursor-pointer duration-100">{address}</p>
      ) : (
        !error && (
    ...
    <form
      ...
      style={{ display: "flex", flexDirection: "column", gap: "12px", padding: "4px 24px" }}
    >
      ...
      <Select
        ...
        required
      >
        <MenuItem value="Rajouri Garden Station">Rajouri Garden Police Station</MenuItem>
        <MenuItem value="Dwarka Mor Station">Dwarka Mor Police Station</MenuItem>
        <MenuItem value="Uttam Nagar Station">Uttam Nagar Police Station</MenuItem>
        <MenuItem value="Janakpuri West Station">Janakpuri West Police Station</MenuItem>
        <MenuItem value="Subhas Nagar Station">Subhas Nagar Police Station</MenuItem>
        <MenuItem value="Karol Bagh Station">Karol Bagh Police Station</MenuItem>
      </Select>
      <FormControl>
        ...
        >
          <FormControlLabel value="Have Seen Crime Being Committed " control={<Radio />} label="Have Seen Crime Being Committed" />
          <FormControlLabel value="Know that crime is being planned" control={<Radio />} label="Know that crime is being planned" />
          <FormControlLabel value="other" control={<Radio />} label="Other" />
        </RadioGroup>
      </FormControl>
      <Button style={{ margin: "auto", width: "200px" }} type="submit" variant="contained">
        Submit
      </Button>
    </form>
  );
